...
} from "/$/moduleTower/components/grid/module/cardApi/index";
import { btnActionTemplate, stringAnyObj } from "../types";
		...
		gridCellMaker(
			...
			},
			{
				props: {
					searchItemTemplate: [],
					showItemTemplate: [
						tableCellTemplateMaker("asdaasd", "asd"),
						tableCellTemplateMaker("asdaasd", "asd"),
						tableCellTemplateMaker("asdaasd", "asd"),
						tableCellTemplateMaker("asdaasd", "asd"),
						tableCellTemplateMaker("asdaasd", "asd"),
					...
					btnList: [
						btnMaker("fuck", btnActionTemplate.Function, {
							icon: "AddLocation",
							function: async (that, data) => {
								ElMessage.success("fuck");
							}
						})
					],
					autoSearch: false
