 ...
 * @LastEditors: CZH
 * @LastEditTime: 2023-08-14 17:25:36
 * @FilePath: /cool-admin-vue/src/modules/moduleTower/modules/userManage/component/searchTable/drawerForm.ts
 */

export const OpenDrawerBtn = () => {};

import { checkContext, refreshDesktop } from "/$/moduleTower/components/grid/module/cardApi";
...
import drawerFormVue from "/$/moduleTower/modules/userManage/component/searchTable/drawerForm.vue";
import {
	stringAnyObj,
	drawerProps,
	closeType,
...
export const btnMaker = (
	...
	options: {
		...
		elType?:
			...
			| "info"
			| ""
			| ((data: stringAnyObj) => "success" | "danger" | "primary" | "warning" | "info" | "");
		[key: string]: any;
	},
	apiList: string[] = [],
	showAbleKey: string = ""
 ...
 */
export const dobuleCheckBtnMaker = (title: string, message: string, options: stringAnyObj = {}) => {
 ...
 */
export const openDrawerForm = (content: { [key: string]: any }, value: drawerProps) => {
 ...
 */
export const openDrawerFormEasy = (that: stringAnyObj, drawerProps: drawerProps) => {
