  ...
  >
    <cardBg
      ...
      :cus-style="{
        padding: '0px',
        height: 'auto',
        paddingBottom: (btnList && btnList.length > 0) || !autoSearch ? '0px' : '0px',
      }"
    >
      <VueForm
        v-model="formData"
        ...
        >
          ...
          >
            <el-button
              ...
              @click="btnClick(item)"
              :type="typeof item.elType != 'string' ? item.elType(formData) : item.elType"
              :plain="
                (typeof item.elType != 'string' ? item.elType(formData) : item.elType) ==
                'info'
              "
              :icon="item.icon"
            >
