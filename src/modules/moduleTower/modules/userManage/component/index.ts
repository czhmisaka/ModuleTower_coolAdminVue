 ...
 * @LastEditors: CZH
 * @LastEditTime: 2023-08-14 17:19:39
 * @FilePath: /cool-admin-vue/src/modules/moduleTower/modules/userManage/component/index.ts
 */
import {
...
const componentGetter = async () => {
	...
	console.log(componentList, "components = requireModule(fileNasdasdasddasdasdas");
	...
	for (let i = 0; i < componentList.length; i++) {
		...
		if (tagInObj(module, ["propsDetail", "componentInfo"], selectTypeTemplate.one))
			componentLists[componentInfo.label as unknown as string] = cardComponentMaker(
	...
	console.log(componentList, componentLists, "moduleList");
